# GRU
**Global Rolling Updater** (GRU) — это система обновления, набор спецификаций и общие принципы развёртывания. Известным проектом, использующим GRU, является [Tor Portable](https://github.com/Verity-Freedom/Tor-Portable).
